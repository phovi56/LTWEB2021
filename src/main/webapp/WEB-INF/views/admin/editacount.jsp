...
<head>
    ...
    <title>L.A.N | Sửa tài khoản</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-6">
                                <input type="text" class="form-control" placeholder="Nhập họ và tên tài khoản...">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align: center;">
                                <button class="btn btn-outline-primary" style="padding-left: 1.2rem; padding-right: 1.2rem; margin-right: 40px;">Lưu</button>
